function Get-InstalledSoftware {
	...
	.EXAMPLE
		PS> Get-InstalledSoftware  -Name 'xxxxxxx'
		
		This example retrieves all software installed on the local computer.
	.PARAMETER ComputerName
		If querying a remote computer, use the computer name here.
        Get-InstalledSoftware -ComputerName xxxxxxx -Name 'xxxxxxx'
    ...
    process {
        try {
            ...
            if ($ComputerName -eq $env:COMPUTERNAME) {
                ...
                Invoke-Command -ComputerName $ComputerName -ScriptBlock $scriptBlock -ArgumentList $PSBoundParameters | Out-HtmlView
            }
        } catch {
